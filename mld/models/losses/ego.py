    ...
    def update(self, rs_set):
        ...
        if self.stage in ["vae", "vae_diffusion"]:
            if self.predict_transl:
                rs_set['joints_ref'], rs_set['joints_rst'], rs_set['pelvis_gt'], 
                rs_set['pelvis_pred'] = self.align_root(rs_set['joints_ref'], 
                                                        rs_set['joints_pred'])
                
                total += self._update_loss("transl_root", rs_set['pelvis_pred'],
                                             rs_set['pelvis_gt'])
