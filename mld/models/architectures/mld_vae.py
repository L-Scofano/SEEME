...
class MldVae(nn.Module):
    ...
    def __init__(self,
        ...
        self.skel_embedding = nn.Linear(input_feats, self.latent_dim) #!!//2)
    ...
    def encode(
        ...
        #bs, nframes, actor, nfeats = features.shape
        ...
        x = self.skel_embedding(x.reshape(-1, nframes*actor, nfeats)).reshape(bs, nframes, actor, -1)
        x = x.view(bs, nframes, -1)
